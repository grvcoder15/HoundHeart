      ...
      <div className="p-8">
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <h1 className="text-4xl font-bold text-gray-900">Travel Club Management</h1>
          </div>
        ...
        <div className="bg-gradient-to-r from-orange-100 to-red-100 border-2 border-orange-400 rounded-lg p-8 text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Travel Club Management Panel</h2>
          <p className="text-gray-700 mb-6">
            Manage dog-friendly destinations, partner hotels, restaurants, and activities worldwide.
          </p>
          ...
          <div className="bg-white rounded-lg p-6 inline-block max-w-2xl">
            ...
            <div className="grid grid-cols-2 gap-4 text-left">
              ...
              <div>✓ Partner Hotels/Restaurants</div>
              <div>✓ Activity Listings</div>
              <div>✓ Booking Integration</div>
              <div>✓ Analytics & Reports</div>
              <div>✓ Partner Commission Tracking</div>
            </div>
          </div>
        </div>
      </div>
...
export default TravelClubAdminPage;
