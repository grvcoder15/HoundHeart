      ...
      <div className="p-8">
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <h1 className="text-4xl font-bold text-gray-900">Charity Partnerships</h1>
          </div>
        ...
        <div className="bg-gradient-to-r from-orange-100 to-red-100 border-2 border-orange-400 rounded-lg p-8 text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Charity Partnerships</h2>
          <p className="text-gray-700 mb-6">
            Manage charity partnerships and donation programs.
          </p>
          ...
          <div className="bg-white rounded-lg p-6 inline-block max-w-2xl">
            ...
            <div className="grid grid-cols-2 gap-4 text-left">
              ...
              <div>✓ Donation Tracking</div>
              <div>✓ Campaign Creation</div>
              <div>✓ Impact Reports</div>
              <div>✓ Payment Processing</div>
              <div>✓ Member Giving History</div>
            </div>
          </div>
        </div>
      </div>
...
export default CharityPartnershipPage;
