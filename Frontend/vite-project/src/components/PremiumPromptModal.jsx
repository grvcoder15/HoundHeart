        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ backgroundColor: 'rgba(0,0,0,0.6)' }}>
            <div className="bg-white rounded-3xl p-8 max-w-md w-full shadow-2xl transform transition-all">
                ...
                <p className="text-center text-gray-600 mb-6">
                    {messageText || 'Upgrade to Premium to access the full Wellness Guide and enjoy all exclusive features.'}
                </p>
                ...
                <div className="space-y-2 mb-6">
                    {['Full Wellness Guide Access', 'Download PDF', 'Unlimited Nerve Center Rituals', 'Premium Features'].map((benefit, idx) => (
